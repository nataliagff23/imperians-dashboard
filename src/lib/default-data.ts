  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        id: 'link-3',
        category_id: 'cat-2',
        title: 'Bóveda de Anuncios Ganadores',
        url: 'https://anuncios.imperiansagency.com',
        description: 'Repositorio de anuncios ganadores de la agencia. Referencia creativa y banco de inspiración para campañas.',
        icon: 'zap',
        sort_order: 2,
        created_at: new Date().toISOString(),
      },
      {
        ...
        category_id: 'cat-2',
        title: 'Wins del Mes',
        url: 'https://wins.imperiansagency.com',
        description: 'Plataforma para que el equipo suba y comparta los wins y logros del mes.',
        icon: 'zap',
        sort_order: 3,
        created_at: new Date().toISOString(),
      },
